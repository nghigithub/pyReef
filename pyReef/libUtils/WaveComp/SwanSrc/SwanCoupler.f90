...
contains
    ...
    !=======================================================================
    subroutine swan_falsereadwave( COMPUT )
...
!        integer, save :: LWINDM = 3     ! type of wind growth formulation
        ...
        call swan_falseinitwave( AC2, SPCSIG, SPCDIR, KGRPNT )
    ...
    end subroutine swan_falsereadwave
    !=======================================================================
    ...
    !=======================================================================
    subroutine swan_falseinitwave( AC2, SPCSIG, SPCDIR, KGRPNT )
...
11      format(' Inc. freq. = ',F9.5, A3, F9.5, '=',A7,' freq')
    ...
    end subroutine swan_falseinitwave
    !=======================================================================
...
!        CASTD = 0.
    ...
    subroutine swan_reinitialise
        ...
        if( inwave ) call swan_falsereadwave( COMPUT )
        if( inwind ) call swan_falsereadwind( COMPUT )

!        if( inwind )then
!          U10 = hcasts( 5 )
!          WDIP = hcasts( 6 ) * DEGRAD
!          WDIC = PI2 * ( WDIP/PI2 - NINT( WDIP/PI2 ) )
!          CALL SWINCO ( AC2   , COMPDA, XCGRID, YCGRID, KGRPNT, SPCDIR, SPCSIG, XYTST )
!          IT0 = 1
!        endif
